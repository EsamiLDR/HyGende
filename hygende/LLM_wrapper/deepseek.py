...
@llm_wrapper_register.register("deepseek")
class deepseekWrapper(LLMWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.api = OpenAI(base_url="https://api.deepseek.com", api_key = 'your_api_key_here')
    ...
    def _batched_generate(
        ...
        **kwargs,
        ...
        client = AsyncOpenAI(base_url="https://api.deepseek.com", api_key = 'your_api_key_here')
